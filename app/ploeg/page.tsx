...
export const metadata: Metadata = {
  ...
  description:
    "Ontmoet de spelers van ZVC Goldgetters. Bekijk onze volledige spelerslijst met foto's en informatie.",
};
...
export default function PloegPage() {
  ...
  return (
    <div className="py-8">
      <div className="mb-8">
        <h1 className="text-4xl font-bold mb-3 text-gold">Onze Ploeg</h1>
